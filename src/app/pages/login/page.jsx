...
{/* email */}
          ...
          <Link href="/pages/forgotPass" className="text-secondary pb-2 hover:text-primary">Fotgot password ?</Link>
          <button
            type="button"
      ...
      <div className="flex  justify-center   ">
        <p className="dark:text-dark-bavit">Don't have an account? <Link href="/pages/signup" className="text-secondary  hover:text-primary">Sign Up</Link></p>
      </div>
    </div>
    </>
  );
